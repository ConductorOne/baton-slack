...
func (o *workspaceRoleType) Grant(
	...
	if principal.Id.ResourceType != resourceTypeUser.Id {
		...
		return nil, uhttp.WrapErrors(codes.PermissionDenied, "only users can be granted workspace role assignments", errors.New("invalid principal type"))
	}
...
func (o *workspaceRoleType) Revoke(
	...
	if principal.Id.ResourceType != resourceTypeUser.Id {
		...
		return nil, uhttp.WrapErrors(codes.PermissionDenied, "only users can have workspace role assignments revoked", errors.New("invalid principal type"))
	}
